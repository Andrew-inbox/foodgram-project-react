    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, validators=[django.core.validators.EmailValidator(message='Некорректный e-mail!')], verbose_name='E-mail')),
                ('username', models.CharField(max_length=150, unique=True, validators=[api.validators.validate_username], verbose_name='Username')),
